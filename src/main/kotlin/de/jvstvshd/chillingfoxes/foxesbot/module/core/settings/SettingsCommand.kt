...
context(CoreModule)
        private suspend fun PublicSlashCommand<SettingsArguments>.channelSettingsSubCommand() =
    publicSubCommand(::ChannelSettingsArguments) {
        name = "channel"
            ...
            this@publicSubCommand.kord.launch {
                ...
                message.edit {
                    ...
                    components(2.minutes) {
                        ...
                        val disableButton = publicButton {
                            label = "Deaktivieren"
