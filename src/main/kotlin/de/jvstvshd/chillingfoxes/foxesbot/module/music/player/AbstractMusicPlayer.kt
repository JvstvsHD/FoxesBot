...
import de.jvstvshd.chillingfoxes.foxesbot.module.music.MusicTrackInfo
...
abstract class AbstractMusicPlayer(override val channel: BaseVoiceChannelBehavior, override val service: MusicService) :
    ...
    override fun trackInfo0(time: Boolean, footerText: String): EmbedBuilder.() -> Unit =
        if (trackInfo == de.jvstvshd.chillingfoxes.foxesbot.module.music.noSongInfo || trackInfo.currentTrack == null) {
            noSongInfo
        } else {
    ...
    open suspend fun exit0(player: AudioPlayer? = null): MusicTrackInfo =
        de.jvstvshd.chillingfoxes.foxesbot.module.music.noSongInfo
