...
class ChangelogProvider(dataSource: HikariDataSource, executor: Executor) : UpdateProvider(executor, dataSource, "gomme_changelog") {

    var authorName: String? = null
    private val baseUrl = "https://www.gommehd.net/forum/"
